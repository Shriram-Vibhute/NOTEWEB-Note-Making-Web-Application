                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        {!localStorage.getItem('token') ? <div className="buttons d-flex">
                            ...
                            <Link className="btn btn-dark" to="/signup" role="button">Signup</Link></div> : <button onClick={handleLogout} id='logout' className="logout btn btn-dark mx-2" to="/login" role="button">Logout</button>}
                    </div>
                </div>
            </nav>
        </div>
